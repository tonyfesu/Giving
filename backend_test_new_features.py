...
def test_business_cause_creation():
    ...
    # Verify basic cause data
    assert cause["name"] == cause_data["name"], f"Expected name to be {cause_data['name']}, got {cause['name']}"
    assert cause["description"] == cause_data["description"], f"Expected description to be {cause_data['description']}, got {cause['description']}"
    assert cause["category"] == cause_data["category"], f"Expected category to be {cause_data['category']}, got {cause['category']}"
    assert cause["impact_metric"] == cause_data["impact_metric"], f"Expected impact_metric to be {cause_data['impact_metric']}, got {cause['impact_metric']}"
    assert cause["cost_per_impact"] == cause_data["cost_per_impact"], f"Expected cost_per_impact to be {cause_data['cost_per_impact']}, got {cause['cost_per_impact']}"
    assert cause["goal_amount"] == cause_data["goal_amount"], f"Expected goal_amount to be {cause_data['goal_amount']}, got {cause['goal_amount']}"
